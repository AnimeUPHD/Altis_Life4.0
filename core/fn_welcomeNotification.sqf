...
"" hintC parseText "<t><t size='1.5'>Welcome to the SecretOne Altis Life server!</t><br/><t color='#EE0000'>Important:</t><br/><t>Set the Action10 button in the ARMA 3 configuration to eg TAB.</t></br><t>You can find the setting in </t><t color='#00FF00'>Configure - Controls - Custom controls - Action button 10</t><br/><t>BY CLICKING CONTINUE YOU CONFIRM THAT YOU HAVE READ THE RULES AT SECRETONE.NET</t></t>";
